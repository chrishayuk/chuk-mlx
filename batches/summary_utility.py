...
def generate_batch_analysis_summary_table(batch_data, batch_file, pad_token_id):
    ...
    summary_table += generate_summary_separator()
    summary_table += generate_summary_row("Average Real Tokens per Row", f"{avg_real_tokens_per_row:,}")
    summary_table += generate_summary_row("Average Padding Tokens per Row", f"{avg_padding_tokens_per_row:,}")
    summary_table += generate_summary_separator()
