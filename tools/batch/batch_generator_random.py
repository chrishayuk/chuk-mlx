...
def main():
    ...
    parser.add_argument('--output_directory', type=str, default='./output/batches/chuk_random', help='Output directory to store the generated .npz batch files. Default: ./output')
