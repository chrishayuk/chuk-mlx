...
from chuk_lazarus.models_v2.core.backend import BackendType, MLXBackend


class TestMLXBackendCreation:
    """Tests for MLXBackend creation."""
...
class TestMLXBackendTensorCreation:
    """Tests for MLXBackend tensor creation."""
...
class TestMLXBackendOperations:
    """Tests for MLXBackend tensor operations."""
...
class TestMLXBackendActivations:
    """Tests for MLXBackend activation functions."""
...
class TestMLXBackendNormalization:
    """Tests for MLXBackend normalization layers."""
...
class TestMLXBackendShapeOperations:
    """Tests for MLXBackend shape operations."""
...
class TestMLXBackendAttention:
    """Tests for MLXBackend attention operations."""
...
class TestMLXBackendGradients:
    """Tests for MLXBackend gradient operations."""
