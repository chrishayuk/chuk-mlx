...
```bash
python batch_loader_test.py --output_directory ./output --file_prefix lazyfox
```
...
```bash
python batch_analyzer.py --batch_file output/lazyfox_batch_0001_target.npy --tokenizer lazyfox_tokenizer
```